...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _project__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./project */ \"./src/project.js\");\n/* harmony import */ var _task__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./task */ \"./src/task.js\");\n/* harmony import */ var _todoList__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./todoList */ \"./src/todoList.js\");\n/* harmony import */ var _UI__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./UI */ \"./src/UI.js\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n\n\n\n\n\nwindow.addEventListener('DOMContentLoaded', event => {\n  console.log('DOM fully loaded and parsed');\n\n  // Logic Testing\n\n  const project1 = new _project__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('projectOne');\n  const project2 = new _project__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('Work');\n\n  // app init / default\n  const todoListOne = new _todoList__WEBPACK_IMPORTED_MODULE_2__[\"default\"]();\n  todoListOne.addProject(project1);\n  todoListOne.addProject(project2);\n  const task1 = new _task__WEBPACK_IMPORTED_MODULE_1__[\"default\"]('taskOne', 'code a todo app', '06/12/2023', 'high');\n  const task2 = new _task__WEBPACK_IMPORTED_MODULE_1__[\"default\"]('taskTwo', 'eat a tasty salad', '07/26/2024', 'low');\n\n  // data format for updating task.\n  // const data = { title: 'bingbong', priority: 'extreme!!' };\n\n  project1.addTask(task1);\n  project1.addTask(task2);\n  console.log(project1);\n  console.log(todoListOne);\n\n  // UI Testing\n  const newUi = new _UI__WEBPACK_IMPORTED_MODULE_3__[\"default\"]();\n\n  // load inbox\n  newUi.loadHome();\n  newUi.initTaskButton();\n  newUi.listenAddTask();\n  newUi.initProjectButton();\n});\n\n//# sourceURL=webpack://todo-list/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ Project)\n/* harmony export */ });\nclass Project {\n  constructor(title) {\n    this.id = crypto.randomUUID();\n    this.title = title;\n    this.tasks = [];\n  }\n  addTask(task) {\n    this.tasks.push(task);\n  }\n  removeTask(task) {\n    const index = this.tasks.indexOf(task);\n    this.tasks.splice(index, 1);\n  }\n  updateTask(taskId, data) {\n    Object.assign(this.tasks.find(obj => obj.id === taskId), data);\n  }\n}\n\n//# sourceURL=webpack://todo-list/./src/project.js?");
